...
names = ['kuba' , 'marcin', 'adrian', 'mateusz', 'kuba', 'maciek', 'ola', 'julia', 'marcin']
imi = input("Podaj imie do wyszukania\n")
print(names.index(imi))
...
user_data = {
    'imie':['kuba','mateusz','ola'],
    'nazwisko':['kowalski', 'nowak','lewandowska'],
    'wiek':[20,30,25]
}
user_id = input('Podaj id uzytkownika do wyszukania (0-2)\n')
print(user_data['imie'][int(user_id)] + ' ' + user_data['nazwisko'][int(user_id)] + ' ' + str(user_data['wiek'][int(user_id)]))
...
new_key = input('Podaj kierunki studiow\n')
user_data.update({
     'kierunek_studiow': [new_key],
    })
print(user_data)
...
x = input('Podaj X\n')
y = input('Podaj Y\n')
result = (2*int(x))+(5*int(y))
print('wyrazenie 2x+5y jest rowne = ' + str(result))
...
print('Jestem ' + a + ' ' + b + ' mam ' + str(c) + ' lat, studiuje ' + d)

## 4. Sprawdź/porównaj czy 1+2+10+20000001+4+347586970885 jest równa 321784560456434534646

summed_numbers = 1+2+10+20000001+4+347586970885
print('czy liczby sa rowne - ' + summed_numbers == 321784560456434534646)
...
sum = x + y
print("Suma x + y = " + str(sum))

dif = x - y
print("Różnica x - y = " + str(dif))

ratio = x * y
print("Iloczyn x * y = " + str(ratio))

if y != 0:
    quotient = x / y
    print("Iloraz x / y = " + str(quotient))
else:
    print("Nie można dzielić przez zero.")

multi = x ** y
print("Potęga x do potęgi y = " + str(multi))
